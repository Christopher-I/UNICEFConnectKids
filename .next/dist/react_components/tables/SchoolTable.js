...
var SchoolTable = function (_React$Component) {
		...
		return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = SchoolTable.__proto__ || (0, _getPrototypeOf2.default)(SchoolTable)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			...
			columns1: [{
				...
				render: function render(bool) {
					if (bool === true) {
						return _react2.default.createElement(_antd.Tag, { color: "green" }, "Connected");
					} else {
						return _react2.default.createElement(_antd.Tag, { color: "red" }, "Not Connected");
					}
				}
			}, {
				title: "",
	...
	(0, _createClass3.default)(SchoolTable, [{
		...
		value: function render() {
			return _react2.default.createElement("div", null, _react2.default.createElement(_antd.Table, {
				...
				successPercent: 30,
				showInfo: false
			}), "GB", _react2.default.createElement("div", { style: { marginBottom: 16 } }, _react2.default.createElement(_sample2.default, null), " ")));
		}
	}]);
