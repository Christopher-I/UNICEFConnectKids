...
contract ISP{
    ...
    function addConnectivityInfo(uint _date, uint _uploadSpeed,uint _downloadSpeed, uint _dataSize) public {
...
contract School{
    ...
    address public currentISPProvider;
    ...
    function updateISPProvider(address _ispAddress) public{
        currentISPProvider = _ispAddress;
    }
    ...
    function getSummary()public view returns(string,address,uint,uint,bool) {
        return (
